...
requirements = python3,kivy,kivymd,pillow,pyjnius,android,openssl,sqlite3,requests,urllib3,tqdm,certifi,openai,typing_extensions,pydantic,httpx,anyio,sniffio,charset_normalizer,distro
